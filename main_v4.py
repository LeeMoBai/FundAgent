...
2. **汇率测谎仪**：若 A 股宽基（如A500）红盘放量，但离岸人民币(USD/CNH)同步大幅贬值（如突破 7.25），必须在 reason 中指出“汇率背离，警惕内资自救诱多，禁止追涨”。
3. **QDII 溢价与时间差警报**：针对华宝纳斯达克等跨境 ETF，14:45申购的是今晚美股未知溢价。若期指(NQ)大跌但国内场内ETF跌幅很小，必须提示“警惕场内高溢价陷阱，拒绝高位接盘”。
...
{{
  ...
  "fund_decisions": {{
    "某某基金": {{
      "action": "动作", // ⚠️ 必须且只能从以下词汇中五选一：["锁仓观望", "左侧狙击", "定投维持", "清仓出局", "静默(已空仓)"]
